 ...
 *
 * 举例而言: 字符串 \text{“abcbabcab”}“abcbabcab”。从开头找到的最大回文子串是 \text{“abcba”}“abcba”，剩下的部分是 \text{“bcab”}“bcab”。因此要求的字符串是 \text{“bcab”}“bcab” 的反转（= \text{“bacb”}“bacb”）+ 原字符串（ = \text{“abcbabcab”}“abcbabcab”）= \text{“bacbabcbabcab”}“bacbabcbabcab”。
 *
 * 算法
 *
